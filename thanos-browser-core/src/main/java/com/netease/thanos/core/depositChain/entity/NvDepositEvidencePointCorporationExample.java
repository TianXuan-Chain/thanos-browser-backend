...
/** 
 * nv_deposit_evidence_point_corporation表查询条件构建对象
 * 
 * @author db-generator
 * @since 2021年06月17日16:10:34
 */ 
public class NvDepositEvidencePointCorporationExample {
    ...
    public NvDepositEvidencePointCorporationExample() {
    ...
    /**
     * nv_deposit_evidence_point_corporation null
     */
